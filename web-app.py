...
if user_menu == 'Medal Tally':
    ...
    if selected_country == "Overall" and selected_year == "Overall":
        ...
        st.title(str(selected_country)+" performance in year " + str(selected_year))
...
if user_menu == "Overall Analysis":
    ...
    nations_over_time = helper.data(df,'region')
    fig = px.line(nations_over_time,x = 'Edition',y = 'region')
    st.title("Participating Nations over the years")
    st.plotly_chart(fig)

    events_over_time = helper.data(df,'Event')
    fig = px.line(events_over_time,x = 'Edition',y = 'Event')
    st.title("Event over the years")
    st.plotly_chart(fig)

    athlete_over_time = helper.data(df,'Name')
...
if user_menu == "Country-wise Analysis":
    ...
    topdf = helper.country_player(df,selected_country)
    st.table(topdf)
